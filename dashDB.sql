...
CREATE TABLE `widgets` (`id` INT(1) AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, directory VARCHAR(255) NOT NULL, disabled ENUM('0', '1') DEFAULT '1' NOT NULL PRIMARY KEY(`id`));
