...
CREATE TABLE `users` (`id` INT(1) AUTO_INCREMENT NOT NULL, `username` VARCHAR(255) NOT NULL, `password` VARCHAR(255) NOT NULL, `email` VARCHAR(255) NOT NULL, `token` VARCHAR(255) NOT NULL, created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP NOT NULL, PRIMARY KEY (`id`));
CREATE TABLE `widgets` (`id` INT(1) AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, directory VARCHAR(255) NOT NULL, PRIMARY KEY(`id`));
